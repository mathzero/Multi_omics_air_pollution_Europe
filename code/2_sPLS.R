...
#[Y] pm25_p Model
Summ_Xprot.Ypm25_p <- PerfSparseOnX(as.matrix(X_protein), as.matrix(data.frame(Y_exposure[,1])), design_protein, niter=50)
...
#[Y] pm25_o Model
Summ_Xprot.Ypm25_o <- PerfSparseOnX(X_protein, data.frame(Y_exposure[,2]), design_protein, niter=50)
...
#[Y] pnc_median Model
Summ_Xprot.Ypnc <- PerfSparseOnX(X_protein, data.frame(Y_exposure[,3]), design_protein, niter=50)
...
#[Y] pnc_diff Model
Summ_Xprot.Ypnc_diff <- PerfSparseOnX(X_protein, data.frame(Y_exposure[,4]), design_protein, niter=50)
...
#[Y] pnc_median Model
Summ_Xtrans.Ypnc <- PerfSparseOnX(X_trans, data.frame(Y_exposure[,3]), design_trans, niter=10)
...
#[Y] pnc_diff Model
Summ_Xtrans.Ypnc_diff <- PerfSparseOnX(X_trans, data.frame(Y_exposure[,4]), design_trans, niter=10)
...
#[Y] pnc_median Model
Summ_Xmethyl.Ypnc <- PerfSparseOnX(X_methyl, data.frame(Y_exposure[,3]), design_methyl, niter=10)
...
#[Y] pnc_diff Model
Summ_Xmethyl.Ypnc_diff <- PerfSparseOnX(X_methyl, data.frame(Y_exposure[,4]), design_methyl, niter=10)
